...
#define FLASH_BASE_ADDR                 ( (uint32_t)0x08000000)   /*typecast to unsigned int*/
...
#define SYSCFG_PER_CLK_EN() (RCC -> RCC_APB2ENR |= (1<<14))//high the 14th bit of RCC_APB2ENR to enable SYSCFG Clock.
